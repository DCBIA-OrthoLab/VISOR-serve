...
The leading underscore is load-bearing: `registry.py` skips folders starting
...
failure half of the contract is tested: no `result.json`, non-zero exit, the
stderr tail attached to the error.
